...
if game.PlaceId == 155615604 then
    ...
    Window = OrionLib:MakeWindow({
        Name = "GamerHub Lite: Prison Life",
        HidePremium = true,
    })
    ...
    tsec:AddDropdown({
        ...
        Callback = function(v)
            ...
            elseif v  == "Yard Tower" then
                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(824.433472, 123.039902, 2586.67554)
            end
        end
    })
    OrionLib:Init()
elseif game.PlaceId == 3956818381 then
    OrionLib:Init()
    Window = OrionLib:MakeWindow({
        Name = "GamerHub Lite: Ninja Legends",
        HidePremium = false,
        SaveConfig = true,
...
elseif game.PlaceId == 2214661900 then
    ...
    Library = OrionLib:MakeWindow({
        Name = "GamerHub Lite: Survive in Area 51",
        HidePremium = false,
        SaveConfig = false,
    })
    ...
    gunsec:AddDropdown({
        ...
        Callback = function(v)
            ...
            if folder then
                ...
                elseif v == "LX2" then
                    local oldpos = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
                    local tpto = folder:FindFirstChild("LX2 - 2300 Cell").Head.CFrame
                    task.wait()
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = tpto
                    task.wait()
                    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = oldpos
...
elseif game.PlaceId == 112420803 then
    Window = OrionLib:MakeWindow({
        Name = "GamerHub Lite: Kohl's Admin",
        HidePremium = true,
        SaveConfig = true,
    ...
    tsec:AddDropdown({
        ...
        Callback = function(v)
            ...
            elseif v == "House" then
                game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(-23.2189274, 8.22999954, 66.7299881)
...
elseif game.PlaceId == 142823291 then
    OrionLib:Init()
    Window = OrionLib:MakeWindow({
        Name = "GamerHub Lite: Murder Mystery 2",
        HidePremium = false,
        SaveConfig = true,
